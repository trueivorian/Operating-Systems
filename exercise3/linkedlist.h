 ...
 *
 */
char* get(list * l, unsigned int index);
 ...
 * #Arguments
 * * `l`    - The list to be modified
 * * `data`   - the string to add to the front of the linkedlist.
 *
 * #Return
 * Returns 0 for successful termination and -1 in case of errors.
 *
 */
int prepend(list * l, char* data);
 ...
 * #Arguments
 * * `l`    - The list to be modified
 * * `data`   - the string to add to the back of the linkedlist.
 *
 * #Return
 * Returns 0 for successful termination and -1 in case of errors.
 *
 */
int append(list * l, char* data);
 ...
 * * `data`   - the string which should be stored in the new element.
 *
 * #Return
 * Returns 0 for successful termination and -1 in case of errors.
 *
 */
int insert(list * l, unsigned int index, char* data);
